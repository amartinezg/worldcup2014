...
User.create(:name => 'LINA ZULUAGA', :mail => 'lzuluaga@tlm.com.co')
User.create(:name => 'ELIZABETH', :mail => 'eperez@tlm.com.co')
User.create(:name => 'ALESSANDRA', :mail => 'asarmiento@tlm.com.co')
User.create(:name => 'SARA', :mail => 'ssanchez@tlm.com.co')
User.create(:name => 'LAURA', :mail => 'llopez@tlm.com.co')
User.create(:name => 'MARTA', :mail => 'mgiraldo@tlm.com.co')
User.create(:name => 'MARISOL', :mail => 'mcastano@tlm.com.co')
User.create(:name => 'OLGA', :mail => 'oospina@tlm.com.co')
User.create(:name => 'YAMILE', :mail => 'ygaleano@tlm.com.co')
User.create(:name => 'YANNETH', :mail => 'yperez@tlm.com.co')
User.create(:name => 'JOSE', :mail => 'icardona@tlm.com.co')
User.create(:name => 'FRANCISCO', :mail => 'fguerra@tlm.com.co')
User.create(:name => 'LESLIE', :mail => 'lrestrepo@tlm.com.co')
User.create(:name => 'GUSTAVO', :mail => 'gechavarria@tlm.com.co')
User.create(:name => 'VANESSA', :mail => 'vrestrepo@tlm.com.co')
User.create(:name => 'ANDRES JARAMILLO', :mail => 'ajaramillo@tlm.com.co')
User.create(:name => 'JAIVER', :mail => 'jgiraldo@tlm.com.co')
User.create(:name => 'ANDRES MARTINEZ', :mail => 'amartinez@tlm.com.co')
User.create(:name => 'AUGUSTO', :mail => 'achacon@tlm.com.co')
User.create(:name => 'JAIME', :mail => 'jjaramillo@tlm.com.co')
User.create(:name => 'ADRIAN', :mail => 'jtrespalacios@tlm.com.co')
