...
class ForecastsControllerTest < ActionController::TestCase
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post :create, forecast: { forecast1: @forecast.forecast1, forecast2: @forecast.forecast2, group: @forecast.group, user_id: @forecast.user_id }
    end
  ...
  test "should update forecast" do
    patch :update, id: @forecast, forecast: { forecast1: @forecast.forecast1, forecast2: @forecast.forecast2, group: @forecast.group, user_id: @forecast.user_id }
    assert_redirected_to forecast_path(assigns(:forecast))
  end
