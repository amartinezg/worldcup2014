...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { forecast_id: @score.forecast_id, points: @score.points, reason: @score.reason, user_id: @score.user_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { forecast_id: @score.forecast_id, points: @score.points, reason: @score.reason, user_id: @score.user_id }
    assert_redirected_to score_path(assigns(:score))
  end
